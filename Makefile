...
EM_LDFLAGS = -Oz --shell-file shell_emscripten.html -sSINGLE_FILE -sMINIFY_HTML=0  -sEXIT_RUNTIME=0 -sINVOKE_RUN=0 -sFORCE_FILESYSTEM=1 -sEXPORTED_FUNCTIONS='["_main"]' -sEXPORTED_RUNTIME_METHODS='["callMain","FS","PATH"]'
